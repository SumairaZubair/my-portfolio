...
const about = {
  title: "About me",
  description:
    "I am a dedicated frontend developer with a passion for creating seamless, user-friendly interfaces.I specialize in HTML, CSS, JavaScript, and have extensive education with modern frameworks like React and Nextjs.",
    info:[
      {
        fieldName: "Name",
        fieldValue: "Sumaira Zubair",
      },
      {
        fieldName: "Phone",
        fieldValue: "03222545319",
      }, {
        fieldName: "Experience",
        fieldValue: "1 year",
      } ,{
        fieldName: "Email",
        fieldValue: "sumairazubair758@gmail.com",
      }, {
...
const skills = {
  title: "My skills",
  description:"I have strong skills in HTML, CSS, and JavaScript, with extensive experience using React for building dynamic, interactive web applications. I'm also skilled in version control using Git, and have a good understanding of Webpack for optimizing frontend performance.",
  skillList:[
   {
    icon: <FaHtml5/>,
    name: "html 5"
            ...
            <TabsContent value="skills" className="w-full h-full">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 xl:gap-[30px]">
                  {skills.skillList.map((skil, index)=>{
                    return(
                      <li key={index}>
